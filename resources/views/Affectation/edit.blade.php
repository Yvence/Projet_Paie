...
@section('contenu')
   ...
   <form action="{{route('Affectation.update',$affectation)}}" method="post">
    @csrf
    @method('post')
    <div class="container border">
    <div class="mb-3">
      <label for="setting-input-3" class="form-label"><h2>Personnel</h2></label>
      <select name="employe_id" id="employe_id" value="{{$affectation->employe_id}}" class="form-control">
        <option value=""></option>
      ...
      <select name="poste_nom" id="poste_nom" value="{{$affectation->poste_nom}}" class="form-control">
        <option value=""></option>
