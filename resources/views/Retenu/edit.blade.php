...
@section('contenu')
 <form action="{{route('Retenu.update',['id'=>$retenu->id])}}" method="post">
  @csrf
  @method('post')
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" name="nom" id="nom" class="form-control" placeholder="Nom"  value="{{$retenu->nom}}" data-parsley-required="true">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="valeur" id="valeur" value="{{$retenu->valeur}}" class="form-control" placeholder="Valeur de l'avantage" >
                                        </div>
                                    </div>
